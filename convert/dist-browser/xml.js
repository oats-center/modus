...
export function parse(xmlstring) {
    ...
    const ret = parseObject({ xml: modus_result, opts: {
            overrides: {
                ...
                "Reports": { type: 'keyedSet', id_attrib: 'ReportID' },
                "DepthRefs": { type: 'keyedSet', id_attrib: 'DepthID' },
                "Depths": { type: 'array' },
                ...
                "NutrientRecommendation": { type: 'keyedSet', id_attrib: 'RecID' },
            ...
            pathRegexParseAsStrings: [
                /Variables\/[^\/]+\/Value/,
                /LifeStageValues\/[^\/]+\/Value/,
                /LabMetaData\/Reports\/[^\/]+\/ReportID/,
